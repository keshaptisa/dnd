...
STEOS_API_TOKEN = os.getenv("STEOS_API_TOKEN")
...
def text_to_speech(text):
    if not STEOS_API_TOKEN:
        raise ValueError("STEOS_API_TOKEN is not set")

    url = f"https://public.api.voice.steos.io/api/v1/synthesize-controller/synthesis-by-text?authToken={STEOS_API_TOKEN}"
